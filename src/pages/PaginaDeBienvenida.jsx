...
export default function PaginaDeBienvenida() {
  ...
  return (
    <div className="flex flex-col items-center justify-center max-h-screen w-full text-center p-4">
      <h1 className="text-4xl font-bold text-blue-500 dark:text-blue-300 mb-6 md:text-6xl">
        Bienvenido a Horas de Servicio
      </h1>

      <p className="text-gray-700 dark:text-gray-200 mb-8 max-w-md sm:text-2xl md:text-3xl md:font-medium">
